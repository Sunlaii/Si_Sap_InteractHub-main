...
• Submitting purchased or downloaded complete projects
• Using AI to generate entire features without understanding
• Sharing your code with other students
7.2 Proper Attribution
• Comment your code to explain complex logic
• Cite external libraries and frameworks used
• Document any code snippets adapted from online sources
• Explain any third-party integrations
Note: Plagiarism will result in a zero grade for the assignment and may lead to
